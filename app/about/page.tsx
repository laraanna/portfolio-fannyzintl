  ...
  return (
    <main className="mx-auto w-[95%] px-9 py-6 space-y-12">
      <section id="section-about" className="pb-8 md:pb-14 md:mt-12">
        <div className="relative group flex gap-6">
          <div className="md:w-[70%] lg:w-[55%]">
            ...
            <p className="text-sm xl:text-lg mb-4">I am a strategy director focused on helping brands grow through clear thinking and strong systems. My work connects brand, business and product to build momentum and turn complex challenges into frameworks that teams can actually use.</p>
            <p className="text-sm xl:text-lg mb-4">I collaborate with companies in different ways: sometimes leading projects, sometimes plugging into existing teams, and sometimes acting as an external strategic partner.</p>
            <p className="text-sm xl:text-lg mb-4">I&apos;m especially drawn to projects where brand and growth aren&apos;t separate conversations, whether that&apos;s helping an early venture find its footing or an established company looking for new momentum.</p>
          </div>
      ...
      <section id="section-contact" className="md:max-w-[70%] lg:max-w-[55%] md:ml-[15%] lg:ml-[22%]">
        ...
        <p className="text-sm xl:text-lg mb-4">I work with brands and teams on projects of all sizes. If you’re looking for a strategic partner or are building something, send me a message. </p>
        <p className="text-sm xl:text-lg">info.fannyzintl@gmail.com / <a href="https://www.linkedin.com/in/fannyzintl/" className="border-b border-black" target="_blank" rel="noopener noreferrer">LinkedIn</a></p>
      </section>
    </main>
  );
}
