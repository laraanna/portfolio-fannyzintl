  ...
  return (
    ...
    >
      <div className="mt-2 text-sm">
        <span className="text-2xl lg:text-2_5xl 2xl:text-4xl font-iowan">{project.brand}</span>
    ...
    <main className="mx-auto w-[95%] px-3 py-6 pt-[100px] md:pt-0 pb-[80px] md:pb-0 min-h-screen flex items-center">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 w-full">
        <div className="flex items-center justify-center">
          <h1 className="text-4_5xl lg:text-6xl xl:text-8xl my-14 md:my-0 font-iowan">I build and <br /> grow brands.</h1>
        </div>
